(function () {
    ...
    function injectCSS() {
        try {
            ...
            s.innerHTML = 
                ...
                /* Загрузчик */
                '.sw-loader{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:16px;padding:60px 20px;color:#cbd5e1}' +
                '.sw-loader-dice{font-size:3.5em;line-height:1;animation:swBounce 1s ease-in-out infinite;filter:drop-shadow(0 4px 16px rgba(133,194,94,.45))}' +
                '.sw-loader-text{font-size:1.1em;font-weight:600;min-height:1.5em;transition:all .3s ease;color:#94a3b8;text-align:center}' +
                '.sw-loader-progress{width:200px;height:3px;border-radius:2px;background:rgba(255,255,255,.08);overflow:hidden;position:relative;margin-top:10px}' +
                '.sw-loader-progress::after{content:"";position:absolute;left:-100%;top:0;height:100%;width:100%;background:linear-gradient(90deg,transparent,#85c25e,transparent);animation:swSlide 1.5s linear infinite}' +
                
                /* Досье (Вердикт) */
                '.sw-dossier{position:relative;padding:24px;border-radius:16px;margin-bottom:24px;background:linear-gradient(145deg,rgba(255,255,255,.07),rgba(255,255,255,.02));border:1px solid rgba(255,255,255,.08);backdrop-filter:blur(10px)}' +
                '.sw-verdict-word{font-family:' + DISPLAY + ';font-size:2.6em;font-weight:900;letter-spacing:-.02em;line-height:1;margin:0 0 8px;text-transform:uppercase}' +
                '.sw-verdict-word.yes{color:#85c25e;text-shadow:0 0 20px rgba(133,194,94,.25)}.sw-verdict-word.no{color:#d9534f;text-shadow:0 0 20px rgba(217,83,79,.25)}.sw-verdict-word.maybe{color:#e0a93b;text-shadow:0 0 20px rgba(224,169,59,.25)}' +
                '.sw-verdict-reason{font-size:1.05em;color:#d1d5db;line-height:1.6;margin:0 0 16px;max-width:65ch}' +
                
                /* Прогресс-бар */
                '.sw-meter{height:8px;border-radius:4px;background:rgba(0,0,0,.4);overflow:hidden}' +
                '.sw-meter-fill{height:100%;width:0;border-radius:4px;transition:width 1s cubic-bezier(.22,1,.36,1)}' +
                '.sw-meter-fill.yes{background:#85c25e}.sw-meter-fill.no{background:#d9534f}.sw-meter-fill.maybe{background:#e0a93b}' +
                
                /* Бейдж режима */
                '.sw-mode-badge{position:absolute;top:20px;right:20px;display:inline-flex;align-items:center;gap:6px;font-size:.75em;padding:4px 12px;border-radius:20px;font-weight:700;letter-spacing:.05em;text-transform:uppercase;background:rgba(0,0,0,.4);border:1px solid rgba(255,255,255,.1)}' +
                ...
                '.sw-mode-dot.active{background:#85c25e;box-shadow:0 0 8px #85c25e}.sw-mode-dot.inactive{background:#777}' +
                
                /* Инфо-грид */
                '.sw-info-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(130px,1fr));gap:12px;margin-bottom:24px}' +
                '.sw-info-item{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.06);border-radius:12px;padding:12px;text-align:center;transition:all .2s}' +
                '.sw-info-label{font-size:.75em;color:#9ca3af;text-transform:uppercase;letter-spacing:.05em;margin-bottom:4px}' +
                '.sw-info-value{font-size:1.1em;font-weight:700;color:#f3f4f6}' +
                
                /* Колонки Плюсы/Минусы */
                '.sw-columns{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:16px;margin-bottom:24px}' +
                '.sw-col{background:rgba(255,255,255,.03);padding:20px;border-radius:14px;border:1px solid rgba(255,255,255,.05)}' +
                '.sw-title{font-family:' + DISPLAY + ';font-size:.9em;font-weight:800;margin-bottom:14px;text-transform:uppercase;display:flex;align-items:center;gap:8px;letter-spacing:.04em}' +
                '.sw-title.pros{color:#85c25e}.sw-title.cons{color:#d9534f}.sw-title.target{color:#e5e7eb}' +
                '.sw-list{margin:0;padding-left:18px;font-size:.95em;line-height:1.6;color:#d1d5db}' +
                '.sw-list li{margin-bottom:8px;padding-left:4px}' +
                
                /* Цитата */
                '.sw-quote{position:relative;background:rgba(255,255,255,.03);border-left:3px solid rgba(255,255,255,.2);border-radius:0 12px 12px 0;padding:16px 20px 16px 24px;margin-bottom:24px}' +
                '.sw-quote-text{font-size:1em;line-height:1.6;color:#e5e7eb;font-style:italic}' +
                '.sw-quote-meta{margin-top:10px;font-size:.8em;color:#9ca3af;display:flex;align-items:center;gap:8px}' +
                '.sw-quote-tone{padding:2px 8px;border-radius:4px;font-style:normal;font-weight:700;text-transform:uppercase;font-size:.7em;letter-spacing:.05em}' +
                '.sw-quote-tone.pos{background:rgba(133,194,94,.15);color:#85c25e}.sw-quote-tone.neg{background:rgba(217,83,79,.15);color:#d9534f}.sw-quote-tone.mix{background:rgba(224,169,59,.15);color:#e0a93b}' +
                
                /* Аудитория */
                '.sw-target-audience{background:linear-gradient(90deg,rgba(133,194,94,.08),transparent);border:1px solid rgba(133,194,94,.15);padding:18px 20px;border-radius:12px;line-height:1.6;color:#d1d5db;font-size:1em;margin-bottom:24px}' +
                '.sw-aud-text{color:#f3f4f6}' +
                
                /* Блок решения и кнопки */
                '.sw-decision{text-align:center;padding:24px;background:rgba(255,255,255,.02);border-radius:16px;border:1px solid rgba(255,255,255,.05);margin-bottom:20px}' +
                '.sw-decision-hint{font-size:.85em;color:#9ca3af;margin-bottom:16px}' +
                '.sw-buttons-row{display:flex;gap:12px;justify-content:center;flex-wrap:wrap}' +
                
                '.sw-btn{font-family:' + DISPLAY + ';font-size:1em;font-weight:700;padding:12px 28px;border-radius:30px;display:inline-flex;align-items:center;gap:10px;transition:all .2s;cursor:pointer;outline:none;border:2px solid transparent;background:rgba(255,255,255,.1);color:#fff}' +
                '.sw-btn.focus{background:#fff;color:#000;transform:scale(1.05);box-shadow:0 0 0 4px rgba(255,255,255,.3)}' +
                '.sw-btn-primary{background:#85c25e;color:#1a1a1a}' +
                '.sw-btn-primary.focus{background:#fff;box-shadow:0 0 0 4px rgba(133,194,94,.4)}' +
                '.sw-btn.shake{animation:swShake .5s}' +
                
                /* Результат костей */
                '.sw-verdict-roll{margin-top:16px;font-family:' + DISPLAY + ';font-size:1.4em;font-weight:900;min-height:32px;text-transform:uppercase;letter-spacing:.01em}' +
                '.sw-verdict-roll.verdict-yes{color:#85c25e;text-shadow:0 0 15px rgba(133,194,94,.4)}' +
                '.sw-verdict-roll.verdict-no{color:#d9534f;text-shadow:0 0 15px rgba(217,83,79,.4)}' +
                
                /* ИИ Чат (Адаптированный для ТВ) */
                '.sw-ai-chat{display:none;background:rgba(0,0,0,.3);border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:20px;margin-top:20px;animation:swFadeIn .3s ease}' +
                '.sw-ai-chat.visible{display:block}' +
                '.sw-ai-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;padding-bottom:12px;border-bottom:1px solid rgba(255,255,255,.08)}' +
                '.sw-ai-title{font-size:1.1em;font-weight:700;color:#f3f4f6;display:flex;align-items:center;gap:8px}' +
                '.sw-ai-close{background:rgba(255,255,255,.1);border:none;color:#fff;cursor:pointer;width:32px;height:32px;border-radius:50%;font-size:1.2em;display:flex;align-items:center;justify-content:center;transition:all .2s}' +
                '.sw-ai-close.focus{background:#fff;color:#000;transform:scale(1.1)}' +
                '.sw-ai-messages{max-height:250px;overflow-y:auto;margin-bottom:16px;padding-right:8px}' +
                '.sw-ai-message{padding:10px 14px;border-radius:12px;margin-bottom:10px;font-size:.95em;line-height:1.5;max-width:85%;animation:swFadeIn .3s ease}' +
                ...
                '.sw-ai-typing{display:flex;gap:5px;padding:12px 16px;background:rgba(255,255,255,.05);border-radius:12px;width:fit-content;margin-bottom:10px}' +
                '.sw-ai-typing span{width:6px;height:6px;background:#9ca3af;border-radius:50%;animation:swBounce .14s infinite ease-in-out both}' +
                ...
                /* Быстрые вопросы (вместо клавиатуры для ТВ) */
                '.sw-ai-suggestions{display:flex;flex-wrap:wrap;gap:8px}' +
                '.sw-ai-chip{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);color:#d1d5db;padding:8px 16px;border-radius:20px;font-size:.85em;cursor:pointer;transition:all .2s;white-space:nowrap}' +
                '.sw-ai-chip.focus{background:#fff;color:#000;border-color:#fff;transform:scale(1.05)}' +
                
                /* Фокус для TV */
                '.sw-focusable{outline:none;cursor:pointer;scroll-margin-top:20px;scroll-margin-bottom:20px}' +
                '.sw-focusable.focus{box-shadow:0 0 0 3px rgba(255,255,255,.8);border-radius:8px;transition:box-shadow .15s ease}' +
                ...
                '@keyframes swBounce{0%,100%{transform:translateY(0)}50%{transform:translateY(-8px)}}' +
                '@keyframes swSlide{0%{left:-100%}100%{left:100%}}' +
                
                /* Мобильная адаптация */
                '@media(max-width:600px){' +
                '.sw-modal-content{padding:16px 16px 30px}' +
                '.sw-verdict-word{font-size:2em}' +
    ...
    function scrollToNavPoint(index) {
        try {
            ...
            if (point && point.length) {
                // Нативный скролл - самый надежный способ для ТВ
                try { point[0].scrollIntoView({ behavior: 'smooth', block: 'center' }); } 
                catch(e) { 
                    var c = window._sw_scrollContainer; 
                    if (c && c.length) c[0].scrollTop = point[0].offsetTop - 40; 
                }
                ...
                setTimeout(function() {
                    try {
                        ...
                        // Ищем первый фокусируемый элемент внутри точки
    ...
    /* ===== ДОГРУЗКА ДАННЫХ (БЕЗ ИЗМЕНЕНИЙ ЛОГИКИ) ===== */
    ...
    function loadMeta(movie) {
        ...
        return Promise.all([
            ...
            var production_companies = [], production_countries = [];
    ...
    function analyze(movie) {
        return Promise.all([ loadCredits(movie), loadMeta(movie) ]).then(function(arr) {
            ...
            return {
                ...
                infoItems: infoItems,
                movie: { title: movie.title || movie.name || 'Фильм', id: movie.id || movie.tmdb_id, type: mediaType(movie) }
            };
        });
    }
    ...
    /* ===== ИИ ЧАТ-БОТ (АДАПТИРОВАННЫЙ ДЛЯ ТВ) ===== */
    function initAIChat(html, movieInfo) {
        try {
            ...
            var chips = html.find('.sw-ai-chip');
            ...
            aiBtn.on('hover:enter click keydown', function(e) {
                ...
                if (window._sw_aiChatOpen) {
                    if (messagesContainer.find('.sw-ai-message').length === 0) {
                        setTimeout(function() {
                            addAIMessage(messagesContainer, 'bot', 'Привет! Я помогу с информацией о фильме. Выберите вопрос ниже.');
                        }, 200);
                    }
                    // Фокус на первый чип или кнопку закрытия
                    setTimeout(function() {
                        var firstChip = chatContainer.find('.sw-ai-chip').first();
                        if (firstChip.length) Lampa.Controller.collectionFocus(firstChip);
                        else Lampa.Controller.collectionFocus(closeBtn);
                    }, 100);
                } else {
            ...
            // Обработка кликов по чипам (быстрым вопросам)
            chips.on('hover:enter click keydown', function(e) {
                if (e.type === 'keydown' && e.keyCode !== 13 && e.keyCode !== 32) return;
                var query = $(this).data('query');
                if (!query) return;
                
                addAIMessage(messagesContainer, 'user', query);
                ...
                setTimeout(function() {
                    ...
                    var response = generateAIResponse(query, movieInfo);
    ...
    function generateAIResponse(query, movieInfo) {
        ...
        if (text.includes('рейтинг') || text.includes('оценка')) {
            var ratingItem = movieInfo.infoItems.find(function(item) { return item.label === 'Рейтинг'; });
            return ratingItem ? 'Рейтинг на TMDB: ' + ratingItem.value : 'Данных о рейтинге нет.';
        }
        ...
        return 'Интересный вопрос! К сожалению, я могу отвечать только на основе доступных данных о фильме.';
    }
    ...
    function buildReadyInner(a) {
        ...
        if (cfg.ai_enabled) {
            ...
            aiChat = '<div class="sw-ai-chat" id="sw-ai-chat">' +
                ...
                '<div class="sw-ai-chip sw-focusable" data-query="О чём этот фильм?" tabindex="0">О чём фильм?</div>' +
                '<div class="sw-ai-chip sw-focusable" data-query="Какой рейтинг и оценки?" tabindex="0">Рейтинг</div>' +
                '<div class="sw-ai-chip sw-focusable" data-query="Сколько длится фильм?" tabindex="0">Длительность</div>' +
                '<div class="sw-ai-chip sw-focusable" data-query="Какой бюджет и сборы?" tabindex="0">Бюджет/Сборы</div>' +
                '<div class="sw-ai-chip sw-focusable" data-query="Когда вышел фильм?" tabindex="0">Год выхода</div>' +
                '</div>' +
                '</div>';
        }
    ...
    function showModal(movie) {
        try {
            ...
            var phrases = ['🔍 Ищу информацию...', '📊 Загружаю данные TMDB...', '💬 Анализирую отзывы...', '🎭 Проверяю ценз...', '⚖️ Формирую вердикт...'];
            
            // ВАЖНО: Убрали кастомную обертку .sw-modal-wrapper, используем нативный контейнер Lampa
            ...
            window._sw_scrollContainer = html; // Скроллим сам контент модалки
            ...
            window._sw_loaderTimer = setInterval(function() {
                ...
                if (t.length) { 
                    t.css('opacity', 0);
                    setTimeout(function(){ t.text(phrases[pi]).css('opacity', 1); }, 200);
                }
            }, 700);
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch Enhanced] v3.0 (Fixed UI/UX for TV, Native Scroll, Chip-based AI)');
    }
